...
- [TAPS] added `axiomhq/tap`
- [TAPS] added `azure/kubelogin`
- [TAPS] added `homebrew/services`
- [TAPS] added `infisical/get-cli`
- [FORMULA] added `argocd`
- [FORMULA] added `atuin`
- [FORMULA] added `axiom`
- [FORMULA] added `checkov`
- [FORMULA] added `duff`
- [FORMULA] added `esptool`
- [FORMULA] added `ffuf`
- [FORMULA] added `gh`
- [FORMULA] added `go`
- [FORMULA] added `hadolint`
- [FORMULA] added `immich-cli`
- [FORMULA] added `infisical`
- [FORMULA] added `node`
- [FORMULA] added `pre-commit`
- [FORMULA] added `prettier`
- [FORMULA] added `repo`
- [FORMULA] added `shfmt`
- [FORMULA] added `syncthing`
- [FORMULA] added `trippy`
- [FORMULA] added `upx`
- [CASK] added `arc`
- [CASK] added `commander-one`
- [CASK] added `copyclip`
- [CASK] added `cyberduck`
- [CASK] added `devtoys`
- [CASK] added `gitkraken-cli`
- [CASK] added `hiddenbar`
- [CASK] added `jabra-direct`
- [CASK] added `insomnia`
- [CASK] added `meta`
- [CASK] added `microsoft-auto-update`
- [CASK] added `monitorcontrol`
- [CASK] added `rar`
- [CASK] added `raycast`
- [CASK] added `ssh-config-editor`
- [CASK] added `warp`
- [CASK] added `wave`
- [CASK] added `wireshark-app`
- [CASK] added `yubico-authenticator`
- [GCLOUD] added `gcloud-cli` cask
- [AZURE] added `azure/kubelogin/kubelogin` formula
- [APPLICATION] upgraded `kubestr` to version 0.4.49
- [APPLICATION] upgraded `polaris` to version 10.1.0
- [APPLICATION] upgraded `dockle` to version 0.4.15
- [TAPS] removed `homebrew/services`
- [CASK] removed `commander-one`
- [CASK] removed `hiddenbar`
- [CASK] removed `ssh-config-editor`
- [CASK] removed `tabby`
- [CASK] removed `datree`
- [CASK] moved `enpass` to optional casks
- [CASK] moved `hiddenbar` to optional casks
- [CASK] moved `jabra-direct` to optional casks
- [CASK] moved `postman` to optional casks
- [CASK] upgraded `zulu17` to `zulu21`
